...
public partial class RssGenerator
{
	private void ValidatePodcastProperties()
	{
		if (string.IsNullOrEmpty(Language))
			Language = "en-US";
		if (PodcastUrl == null || string.IsNullOrEmpty(PodcastUrl.ToString()))
		...
		if (HomePageUrl == null || string.IsNullOrEmpty(HomePageUrl.ToString()))
	...
	private static void ValidateEpisodeProperties(Episode episode)
	{
